...
<script>
    ...
    ~ function () {
        ...
        var Pict = function (img, title, text, x, y, z, w, h) {
            ...
            this.srcimg.src = "/assets/img/" + img;
...
<div class="fixed_content">
    ...
    <p></p>
    <p></p>
    <span class="btn btn-class btn-danger btn-xs" style="text-indent:0px;float:right;margin-right:22px;" onclick="window.location.href='{{Route('index.summer_death')}}'">进入下一步</span>
</div>
</body>
</html>