...
{{--                url:"{{Route('index.alert_ajax_pwd')}}"--}}
    ...
    <div id="screen">
        ...
        <div id="cube">
            ...
            <img class="face" src="/img/love/panzi/present.jpg" style="transform:translateX(-400px) translateZ(200px)">
            <img class="face" src="/img/love/panzi/present.jpg" style="transform:translateX(-400px) translateZ(200px)">
            <img class="face" src="/img/love/panzi/present.jpg" style="transform:translateX(-400px) translateZ(200px)">
            <img class="face" src="/img/love/panzi/present.jpg" style="transform:translateX(-400px) translateZ(200px)">
            <img class="face" src="/img/love/panzi/present.jpg" style="transform:translateX(-400px) translateZ(200px)">
    ...
    <div class="fixed_content">
        ...
        <span class="btn btn-class btn-danger btn-xs" style="text-indent:0px;float:right;margin-right:22px;" onclick="window.location.href='{{Route('panzi.wall')}}'">点我点我</span>
    </div>
