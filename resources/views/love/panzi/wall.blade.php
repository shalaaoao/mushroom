...
<script>
    ...
    ~ function () {
        ...
        var Pict = function (img, title, text, x, y, z, w, h) {
            ...
            this.srcimg.src = "/img/love/panzi/" + img;
        ...
        objects.push(
                new Pict(
                        'secret_today.jpg',
                        'Today Secret', "Sth will come today",
                        -2,-0.7,.4,2,1.4
                )
        );
        ...
        objects.push(
                new Pict(
                        'mushroom.jpg',
                        'Shalaaoao', "Welcome to www.shalaaoao.com",
                        0.5,-.6,.2,2,1.4
                )
        );
        ...
        objects.push(
                new Pict(
                        'guitar.jpg',
                        'Guitar', "Please enjoy my music world",
                        -1.5,-.8,0,1.5,2
                )
        );
        ...
        objects.push(
                new Pict(
                        'sunflower.jpg',
                        'Sunflower', "To hope you always sun shine",
                        -2,-1,-.8,1.5,2
                )
        );
...
<link rel="stylesheet" href="/css/love/panzi/present.css">

<div class="fixed_content">
    这是礼物墙哦，亲<br/>
    <p></p>
        我想，不用我说太多，你也能明白这是啥意思
    <p></p>
    <p></p>
    <p></p>
    <span class="btn btn-class btn-danger btn-xs" style="text-indent:0px;float:right;margin-right:22px;" onclick="window.location.href='{{Route('panzi.summer_death')}}'">进入下一步</span>
</div>
</body>
</html>