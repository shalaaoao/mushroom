...
@section('content')
    <link href="/css/common/landing-page.css" rel="stylesheet">
    <link href="/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    <link href="/css/common/google-font.css" rel="stylesheet" type="text/css">
    <link href="/css/common/common.css" rel="stylesheet" type="text/css">
    <script src="/js/common/html5shiv.js"></script>
    {{--<script src="/js/common/1.4.2/respond.min.js"></script>--}}
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 col-lg-offset-2 col-sm-6">
                    <img class="img-responsive" src="/img/index/ipad.png" alt="">
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-sm-pull-6  col-sm-6">
                    <img class="img-responsive" src="/img/index/dog.png" alt="">
                </div>
            </div>
    ...
    <div class="content-section-a">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-lg-offset-2 col-sm-6">
                    <img class="img-responsive" src="/img/index/phones.png" alt="">
                </div>
            </div>
    ...
    <script>
        $(function(){
            $('.btn_true').click(function(){
                alert('pp我好想你');
                window.location.href="{{Route('panzi.alert')}}";
            })
